...
public class adminstration_add_info extends AppCompatActivity {
    EditText name, pnumber, designation, email;
    Spinner spinner, spinner4;
    TextView save;
...
//    String[] category= { "football","cricket" ,"baseball"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminstration_add_info);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id){
                    ...
                    case R.id.logout:
                        ...
                        Toast.makeText(adminstration_add_info.this, "Logged Out", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.help:
