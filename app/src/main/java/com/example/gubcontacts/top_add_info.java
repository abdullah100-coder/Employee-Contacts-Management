...
public class top_add_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_add_info);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id){
                    ...
                    case R.id.logout:
                        ...
                        Toast.makeText(top_add_info.this, "Logged Out", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.help:
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.Campus_name, android.R.layout.simple_spinner_item);
