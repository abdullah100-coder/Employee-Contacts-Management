...
public class speed_dail extends AppCompatActivity {
    //CONTENTS FOR NAV
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speed_dail);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id){
                    ...
                    case R.id.login:
                        ...
                        break;
                    case R.id.logout:
                        Toast.makeText(speed_dail.this, "You are not logged in", Toast.LENGTH_SHORT).show();
